...
REFERENCE_TEMPLATE_COLUMNS: dict[str, list[str]] = {
    ...
    "products": ["SKU", "Производитель", "Наименование"],
    "holdings": ["Наименование", "External ID"],
    "counterparties": ["Наименование", "External ID", "Holding ID"],
    "delivery_points": ["Наименование", "External ID", "Counterparty ID", "Адрес"],
}


REFERENCE_TEMPLATE_EXAMPLES: dict[str, list[object]] = {
    "cost": ["000000000001234567", "Пример производителя", "Пример товара", 1250.75],
    "stock": ["000000000001234567", "Пример производителя", "Пример товара", 24],
    "products": ["000000000001234567", "Пример производителя", "Пример товара"],
